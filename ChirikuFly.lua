-- Key System
loadstring(game:HttpGet("https://raw.githubusercontent.com/Chiriku2013/Getkey/refs/heads/main/Getkey.lua"))(function(validKey)
    -- Kiểm tra key hợp lệ
    if validKey == "ChirikuNigga" then
        -- Nếu key đúng, xóa UI get key và tiếp tục chạy script fly movement
        ...
        -- Close the get key UI when key is correct
        if ScreenGui then
            ScreenGui:Destroy()
        end
    else
        -- Key không hợp lệ, thông báo
